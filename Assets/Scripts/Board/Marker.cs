...
public class Marker : WritingTool
{
    ...
    private void Start()
    {
        ...
        _board      = _appManager.BoardTransform.GetComponentInChildren<Board.Board>();
    ...
    private bool Draw(RaycastHit _touch)
    {
        ...
        {
            _board    ??= _touch.transform.GetComponent<Board.Board>();
                                      ...
                                      float destY, Color[] colors, float size)
    {
        ...
        Board.Board.Instance.texture.SetPixels(x, y, castSize,
                                         castSize, colors);

        Board.Board.Instance.texture.SetPixels((int) destX, (int) destY, castSize,
                                         castSize, colors);
        ...
        for (var f = 0.01f; f < 1.00f; f += Tools.Instance.coverage)
        {
            ...
            Board.Board.Instance.texture.SetPixels(lerpX, lerpY, castSize,
                                             castSize, colors);
        }
    }
